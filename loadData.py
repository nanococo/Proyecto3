...
def loadCountries():
    ...
    countriesFile = open("dataFiles/Paises.txt", 'r')
...
def loadCities():
    ...
    countriesFile = open("dataFiles/Ciudades.txt", 'r')
...
def loadConnections(countryCityList):
    ...
    countriesFile = open("dataFiles/Conexiones.txt", 'r')
    splitList = [line.replace("\n", "").strip().split(";", ) for line in countriesFile.readlines() if line.strip()]
    keysList = []
    final = []
...
def loadAttractions(countryCityList):
    ...
    for i in splitList:
        if len(i)==5:
            if i[2] not in keysList:
                if countryAndCityExistInList(i[0], i[1], countryCityList):
                    keysList.append(i[2])
                    final.append(i)
    return final
...
####################################################################################333
    ...
    def __init__(self):
        ...
        # Attractions
        self.attractions = loadAttractions(self.countryCities)
